...
X(LCB_ERR_RATE_LIMITING_FAILURE,    220, LCB_ERROR_TYPE_SHARED, 0, "The service decided that the caller must be rate limited due to exceeding a rate threshold") \
X(LCB_ERR_QUOTA_LIMITING_FAILURE,   221, LCB_ERROR_TYPE_SHARED, 0, "The service decided that the caller must be limited due to exceeding a quota threshold") \
\
