...
* CCBC-1413: Skip `SELECT_BUCKET` packets waiting retry queue. Solves possible issues with stalling `lcb_wait`.
* CCBC-1410: Refactor dynamic authenticator. Note that this part API is private and might change in future.
* CCBC-1412: Fixed lifetime error for collection/scope in error contexts.
* CCBC-1406: Fill in prepared statement handle on retry.
* CCBC-1402: Fix parsing JSON primitives as query rows. Solves issues with parsing results of `SELECT RAW ...` queries.
