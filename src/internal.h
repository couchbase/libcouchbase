...
extern "C" {
    ...
    struct lcb_bootstrap_st {
        ...
        union {
            struct lcb_http_bootstrap_st http;
            struct lcb_cccp_bootstrap_st cccp;
        } via;
    };

    struct lcb_config_st {
